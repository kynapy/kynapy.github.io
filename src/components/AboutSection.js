    ...
    return (
        ...
        >
            ...
            <Text
                ...
                fontSize={18}
            >
                Fresh graduate from the National University of Singapore (NUS),
                with a major in Life Sciences and a minor in Computer Sciences.
            </Text>
            ...
            <HStack>
                <li>
                    <a href='https://www.github.com/kynapy'>
                        <FontAwesomeIcon
                            icon={faGithub}
                            size='3x'
                ...
                <li>
                    <a href='https://www.linkedin.com/in/kiyan-ang'>
                        <FontAwesomeIcon
                            icon={faLinkedin}
                            size='3x'
                        />
