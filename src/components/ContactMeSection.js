    ...
    return (
        ...
        >
            ...
            <Text id='formDescription'>
                Do feel free to give me any feedback or comments on this
                website, as I happily welcome ways to improve my code. Do also
                drop any questions and I would get back to you!
            </Text>
            <div>
                <form
            ...
            <FormSubmitResponse
                ...
                setTrigger={setFormSubmitted}
            >
                <Heading style={{ paddingBottom: '20px' }}>Success!</Heading>
                <Text>
                    Thank you, your message has been sent and I will get back to
                    you shortly!
                </Text>
            </FormSubmitResponse>
        </VStack>
